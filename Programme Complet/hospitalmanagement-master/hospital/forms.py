...
class InfirmierUserForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ["first_name", "last_name", "username", "password"]
        widgets = {"password": forms.PasswordInput()}
...
class InfirmierForm(forms.ModelForm):
    class Meta:
        model = models.Infirmier
        fields = ["address", "mobile", "department", "status", "profile_pic"]


# for student related form
class ReceptionisteUserForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ["first_name", "last_name", "username", "password"]
        widgets = {"password": forms.PasswordInput()}
...
class ReceptionisteForm(forms.ModelForm):
    class Meta:
        model = models.Receptioniste
...
class PatientForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ["address", "mobile", "symptoms", "cin"]
